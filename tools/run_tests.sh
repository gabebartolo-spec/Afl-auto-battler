...
ALL_SUITES=(draft draft_ui intake intake_ui expansion finals save career_ui potential ai training selection injuries awards contracts league club match_game league_balance calibration balance)
