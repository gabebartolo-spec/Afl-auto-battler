...
ORDER = [
    ...
    ("eval_05_3", "ai", "Club evaluation SD ~ U[0.5,3], in full"),
    ("eval_1_4", "ai", "Club evaluation SD ~ U[1,4], in full"),
    ("eval_1_5", "ai", "Club evaluation SD ~ U[1,5], in full"),
    ("eval_15_6", "ai", "Club evaluation SD ~ U[1.5,6], in full"),
    ("evn_1_5", "ai", "Club evaluation SD ~ U[1,5], by need"),
