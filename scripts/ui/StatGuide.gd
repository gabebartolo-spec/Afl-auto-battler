...
const TOPICS := [
	...
	["Team form", "Every club's last five results set its form, from Cold (-100) through Steady (0) to Hot (+100); the latest game counts most (30%, then 25, 20, 15, 10). Five straight wins is the cap, a sixth adds nothing, and one loss takes a Hot side back to Good. Form gives a small edge in composure (up to 5% fewer clangers) and at stoppages (a third of home-ground advantage): a Hot side beats a Steady one about 3% more often. It resets every season. The hub shows yours and your next opponent's."],
	...
	["XP and cost", "Every player on your list earns XP each game: more for playing, more for a big game. A fit player left out of the 22 plays in the reserves and earns half a full senior game; injured or rested players earn only the squad share. A stat point costs more the higher the stat already is, up to half price while a player is below his POT and 50% dearer once he is past it. 99 is the cap."],
