...
func _show_help() -> void:
	...
	var text := UiKit.lbl(
			...
			+ "4. Play 24 rounds, with matches driven by your players' rated abilities. Set your tactics in the coach box. After each game every player earns XP (fit players you leave out develop in the reserves at about half the senior rate), and his training plan spends it automatically (Position plan to start). Change plans, or buy stats by hand, in Training.\n\n"
